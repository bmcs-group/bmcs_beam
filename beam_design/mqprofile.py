...
from bmcs_beam.moment_curvature.moment_curvature_ import MomentCurvature
...
class BeamBending(InteractiveModel):
    ...
    def get_phi_x(self):
        ...
        phi_x = np.cumtrapz(kappa_x, self.x, initial=0)
    ...
    def get_w_x(self):
        ...
        w_x = np.cumtrapz(phi_x, self.x, initial=0)
        w_x += w_x[0]
        return w_x
